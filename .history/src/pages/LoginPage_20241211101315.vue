<template>
    ...
    <div v-if="showVideo" class="video-screen">
      <video ref="videoPlayer" autoplay muted controls class="autoplay-video" @ended="onVideoEnded">
        <source src="@/assets/video.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      <button class="btn skip-btn" @click="onSkipClick">Skip</button>
    </div>
 ...
 export default {
  ...
  methods: {
    ...
    showLoadingScreen() {
      ...
      }, 10100); // Loading delay before navigating
    },
  },
};
  </script>
