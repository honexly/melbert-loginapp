...
h1{
  font-size: 4.5rem;
  font-family: "Friz Quadrata", serif; /* Approximation */
    font-size: 3rem;
    text-align: center;
    background: linear-gradient(90deg, #C39232, #E1B869, #F0DFAF, #C39232);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    font-weight: bold;
    text-shadow: 2px 2px 6px rgba(0, 0, 0, 0.9); /* Stronger shadow for depth */
