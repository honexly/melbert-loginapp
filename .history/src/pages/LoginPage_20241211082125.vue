<template>
    ...
    <div class="login-wrapper" v-else>
      <!-- <div class="lol-logo">
        <img src="@/assets/lol-logo.png" alt="LOL Logo" />
      </div> -->
...
h1{
  ...
  font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif;
  text-transform: uppercase;
  font-family: "Friz Quadrata", serif; /* Approximation, use if you have access */
    text-align: center;
    background: linear-gradient(90deg, #9B7A37, #C8AA6E, #F0DFAF);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    font-weight: bold;
    text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.8); /* Shadow for depth */
